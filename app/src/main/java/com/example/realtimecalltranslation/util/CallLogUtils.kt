...
object CallLogUtils { // Changed to an object for utility functions
    ...
    fun addCallToDeviceLog(
        context: Context,
        number: String?,
        type: Int, // e.g., CallLog.Calls.OUTGOING_TYPE
        ...
        val values = ContentValues().apply {
            ...
            // For more complete logs, you might also add:
            // put(CallLog.Calls.CACHED_NAME, "...") - if you have the contact name
            // put(CallLog.Calls.NEW, 1) - to mark as a new call
            // put(CallLog.Calls.IS_READ, 0) - to mark as unread initially
        }
